...
interface Settlement {
  ...
  result: string | null;
  createdAt: string;
  resolvedBy: string | null; // null = auto-resolved (live-price market)
}
                  ...
                  >
                    <div>
                      ...
                      <p style={{ fontSize: 11, color: "var(--text-muted)", margin: 0 }}>
                        {parseApiDate(s.createdAt).toLocaleDateString()} · {s.resolvedBy ? `resolved by ${s.resolvedBy}` : "auto-resolved"}
                      </p>
                    </div>
